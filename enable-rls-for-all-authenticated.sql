-- Script para permitir acceso a TODOS los usuarios autenticados (más seguro que deshabilitar RLS)
-- Ejecuta este script completo en Supabase SQL Editor
-- Esta opción mantiene RLS habilitado pero permite acceso a cualquier usuario autenticado
...
-- NOTAS:
-- ============================================
-- 1. Este script mantiene RLS habilitado pero permite acceso a TODOS los usuarios autenticados
-- 2. Es más seguro que deshabilitar RLS completamente
-- 3. Cualquier usuario autenticado puede ver/modificar/eliminar todos los datos
-- 4. Solo usar en desarrollo/testing
